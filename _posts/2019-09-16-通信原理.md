- 所用教材：[樊昌信,等.通信原理(第7版).北京:国防工业出版社,2012](<http://www.ndip.cn/products_detail/productId=83.html>)
  ...
  ![通信系统模型](<https://raw.githubusercontent.com/ZiqingZhao/ZiqingZhao.github.io/master/img/%E9%80%9A%E4%BF%A1%E7%B3%BB%E7%BB%9F%E6%A8%A1%E5%9E%8B.png>)
  ...
  **功率谱密度：维纳—辛钦定理**：
  ...
  $$
  P_{\xi_o}(\omega)=\mathscr{F}[R_{\xi{_o}}(\tau)]|H(\omega^2)|
  $$
  ...
  **相位**：$$\varphi(t)=arctan\frac{z_s(t)}{z_c(t)},0\le\varphi\le2\pi$$。
  ...
  功率谱密度：$$P_n(f)=\left\{ \begin{array}{} \frac{n_0}{2}, &\big|f\big|\le f_H\\ 0,&其它\end{array}\right.$$

  自相关函数：$$R(\tau)=n_0f_H\frac{sin2\pi f_H\tau}{2\pi f_H\tau}$$

  ![带限白噪声](https://raw.githubusercontent.com/ZiqingZhao/ZiqingZhao.github.io/master/img/带限白噪声.jpg)
  ...
  功率谱密度：$$P_n(f)=\left\{ \begin{array}{} \frac{n_0}{2}, &f_c-B/2 \le \big|f\big| \le f_c+B/2\\ 0,&其它\end{array}\right.$$

  自相关函数：$$R(\tau)=n_0B\frac{sin\pi B\tau}{\pi B\tau}cos2\pi f_c\tau$$
  ...
  ![信道](https://raw.githubusercontent.com/ZiqingZhao/ZiqingZhao.github.io/master/img/信道.jpg)

  ### 信道数学模型

  ![信道数学模型](https://raw.githubusercontent.com/ZiqingZhao/ZiqingZhao.github.io/master/img/信道数学模型.png)
  ...
  **无线信道**利用的是电磁波在空间中的传播。根据通信距离、频率和位置的不同，电磁波的传播主要分为**地波**、**天波**（电离层反射波）和**视线传播**。
  ...
  ![幅度调制器](https://raw.githubusercontent.com/ZiqingZhao/ZiqingZhao.github.io/master/img/幅度调制器.png)
  ...
  **残留边带调幅（VSB）**：$$H(\omega)$$是特定的互补特性滤波器
  ...
  ![单边带调制-滤波法](https://raw.githubusercontent.com/ZiqingZhao/ZiqingZhao.github.io/master/img/单边带调制-滤波法.png)
  ...
  \left\{
  \begin{array}{}
      1,& \big|\omega\big|>\omega_c\\
      0,& \big|\omega\big|\le\omega_c
  \end{array}
  \right.
  $$
  ...
  $$
  H(\omega)=H_{LSB}(\omega)=\left\{\begin{array}{}    1,& \big|\omega\big|<\omega_c\\    0,& \big|\omega\big|\ge\omega_c\end{array}\right.
  $$
  ...
  ![单边带调制-相移法](https://raw.githubusercontent.com/ZiqingZhao/ZiqingZhao.github.io/master/img/单边带调制-相移法.jpg)
  ...
  $$
  H(\omega+\omega_c)+H(\omega-\omega_c)=常数， |\omega|\le\omega_H
  $$
  ...
  ![数字基带传输系统](https://raw.githubusercontent.com/ZiqingZhao/ZiqingZhao.github.io/master/img/数字基带传输系统.png)
  ...
  $$
  P_v(f)=\sum\limits^\infty_{m=-\infty}|f_s[PG_1(mf_S)+(1-P)G_2(mfs)]|^2\delta(f-mf_S)
  $$
  ...
  P_s(f)
  &=P_u(f)+P_v(f)\\
  &=f_sP(1-P)|G_1(f)-G_2(f)|^2+\sum\limits^\infty_{m=-\infty}|f_s[PG_1(mf_S)+(1-P)G_2(mfs)]|^2\delta(f-mf_S)
  \end{align}
  $$
  ...
  **编码规则**：“1”码交替用“11”和“00”两位码表示；“0”码固定地用“01”表示。
  ...
  ![数字基带传输系统2](https://raw.githubusercontent.com/ZiqingZhao/ZiqingZhao.github.io/master/img/数字基带传输系统2.png)
  ...
  ![数字基带传输系统3](https://raw.githubusercontent.com/ZiqingZhao/ZiqingZhao.github.io/master/img/数字基带传输系统3.png)
  ...
  \left\{
  \begin{array}{}
  T_s, &0\le|\omega|<\frac{(1-\alpha)\pi}{T_S}\\
  \frac{T_s}{2}[1+sin\frac{T_s}{2\alpha}(\frac{\pi}{T_s}-\omega)], & \frac{(1-\alpha)\pi}{T_S}\le|\omega|<\frac{(1+\alpha)\pi}{T_S}\\
  0, &|\omega|>\frac{(1+\alpha)\pi}{T_S}
  \end{array}
  \right.
  $$
  ...
  \left\{
  \begin{array}{}
  \frac{T_s}{2}(1+cos\frac{\omega T_S}{2}), &|\omega|\le\frac{2\pi}{T_S}\\
  0, &|\omega|>\frac{2\pi}{T_S}
  \end{array}
  \right.
  $$
  ...
  \begin{align}
  T(\omega)
  &=\frac{T_s}{\sum\limits_{i}H(\omega+\frac{2\pi i}{T_s})},|\omega|\le\frac{\pi}{T_s}\\
  ...
  ![横向滤波器](https://raw.githubusercontent.com/ZiqingZhao/ZiqingZhao.github.io/master/img/横向滤波器.jpg)
  ...
  **最大似然准则**：若$$\frac{P(1)}{P(0)}<\frac{f_0(r)}{f_1(r)}$$，则判为“0”；若$$\frac{P(1)}{P(0)}>\frac{f_0(r_0)}{f_1(r_0)}$$，则判为“1”。
  ...
  ![最佳接收机](https://raw.githubusercontent.com/ZiqingZhao/ZiqingZhao.github.io/master/img/最佳接收机.png)

  若先验概率相等，则$$W_0=W_1$$,判决准则简化为$$\int_0^{T_s}r(t)s_1(t)dt<\int_0^{T_s}r(t)s_0(t)dt$$，原理方框图简化成

  ![最佳接收机2](https://raw.githubusercontent.com/ZiqingZhao/ZiqingZhao.github.io/master/img/最佳接收机2.png)
  ...
  ![误码率曲线](https://raw.githubusercontent.com/ZiqingZhao/ZiqingZhao.github.io/master/img/误码率曲线.jpg)

  #### 实际接收机与最佳接收机性能比较

  ![实际接收机与最佳接收机性能比较](https://raw.githubusercontent.com/ZiqingZhao/ZiqingZhao.github.io/master/img/实际接收机与最佳接收机性能比较.jpg)
  ...
  ![匹配滤波器](https://raw.githubusercontent.com/ZiqingZhao/ZiqingZhao.github.io/master/img/匹配滤波器.jpg)
  ...
  ![2ASK_模拟调制法](https://raw.githubusercontent.com/ZiqingZhao/ZiqingZhao.github.io/master/img/2ASK_模拟调制法.jpg)

  - 键控法

  ![2ASK_键控法](https://raw.githubusercontent.com/ZiqingZhao/ZiqingZhao.github.io/master/img/2ASK_键控法.jpg)

  ##### 解调方法

  - 非相干解调（包络检波法）

  ![2ASK_包络检波](https://raw.githubusercontent.com/ZiqingZhao/ZiqingZhao.github.io/master/img/2ASK_包络检波.jpg)

  - 相干解调（同步检测法）

  ![2ASK_相干解调](https://raw.githubusercontent.com/ZiqingZhao/ZiqingZhao.github.io/master/img/2ASK_相干解调.jpg)
  ...
  &= \frac{T_s}{16}\left[\bigg|\frac{sin\pi(f+f_c)T_s}{\pi(f+f_c)T_s}\bigg|^2+\bigg|\frac{sin\pi(f-f_c)T_s}{\pi(f-f_c)T_s}\bigg|^2\right]+\frac{1}{16}[\delta(f+f_c)+\delta(f-f_c)]
  \end{aligned}
  $$
  ...
  ![2FSK_键控法](<https://raw.githubusercontent.com/ZiqingZhao/ZiqingZhao.github.io/master/img/2FSK_键控法.jpg>)

  ##### 解调方法

  - 非相干解调

  ![2FSK_包络检波](<https://raw.githubusercontent.com/ZiqingZhao/ZiqingZhao.github.io/master/img/2FSK_包络检波.jpg>)

  - 相干解调

  ![2FSK_相干解调](<https://raw.githubusercontent.com/ZiqingZhao/ZiqingZhao.github.io/master/img/2FSK_相干解调.jpg>)
  ...
  ![2PSK_模拟调制法](https://raw.githubusercontent.com/ZiqingZhao/ZiqingZhao.github.io/master/img/2PSK_模拟调制法.jpg)

  - 键控法

  ![2PSK_键控法](https://raw.githubusercontent.com/ZiqingZhao/ZiqingZhao.github.io/master/img/2PSK_键控法.jpg)

  ##### 解调方法

  - 相干解调

  ![2PSK_相干解调](https://raw.githubusercontent.com/ZiqingZhao/ZiqingZhao.github.io/master/img/2PSK_相干解调.jpg)
  ...
  ![2DPSK_键控法](https://raw.githubusercontent.com/ZiqingZhao/ZiqingZhao.github.io/master/img/2DPSK_键控法.jpg)

  ##### 解调方法

  - 相干解调+码反变换法

  ![2DPSK_相干解调加码反变换](https://raw.githubusercontent.com/ZiqingZhao/ZiqingZhao.github.io/master/img/2DPSK_相干解调加码反变换.jpg)

  > 解决了相位模糊的问题。

  - 差分相干解调（相位比较）法

  ![2DPSK_差分相干解调](https://raw.githubusercontent.com/ZiqingZhao/ZiqingZhao.github.io/master/img/2DPSK_差分相干解调.jpg)
  ...
  ![二进制数字调制系统的抗噪声性能](https://raw.githubusercontent.com/ZiqingZhao/ZiqingZhao.github.io/master/img/二进制数字调制系统的抗噪声性能.jpg)
