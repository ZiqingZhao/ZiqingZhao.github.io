...
功率谱密度：$$P_n(f)=\left\{ \begin{array}{} \frac{n_0}{2}, &|f|\le f_H\\ 0,&其它\end{array}\right.$$
...
功率谱密度：$$P_n(f)=\left\{ \begin{array}{} \frac{n_0}{2}, &f_c-B/2 \le |f| \le f_c+B/2\\ 0,&其它\end{array}\right.$$
...
$$
H(\omega)=H_{LSB}(\omega)=\left\{\begin{array}{}    1,& |\omega|<\omega_c\\    0,& |\omega|\ge\omega_c\end{array}\right.
$$
